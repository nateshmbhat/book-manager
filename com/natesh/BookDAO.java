...
public class BookDAO {
	...
	private static DefaultTableModel searchByField(String field, String val) {
		...
		colNames.add("Book ISBN") ; colNames.add("Title") ; colNames.add("Category") ;
		try {
			ps = con.prepareStatement(sql);
	...
	public static DefaultTableModel listAll() {
		...
		Vector<Vector<String>> data = new Vector<Vector<String>>() ;
		Vector<String> colNames = new Vector<String>() ;
		colNames.add("ISBN") ; colNames.add("Title") ; colNames.add("Category") ;
		colNames.add("Author Name") ; colNames.add("Author Email") ;
	...
	public static DefaultTableModel SearchByAuthor(String name) {
